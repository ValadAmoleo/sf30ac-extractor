...
def get_games():
    ...
    acaneogeo_mslug_2001 = Game("Metal Slug (MAME 2001)", conversion_type_acaneogeo, "ACA NEOGEO METAL SLUG v131072 (0100EBE002B3E800) (UPD)", "mslug-2001")
    acaneogeo_mslug_2001.compatibility.extend(["BROKEN - MAME-2001"])
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-c1.c1", "201-ca"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-c1.c2", "201-cb"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-c1.c3", "201-cc"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-c1.c4", "201-cd"))
    acaneogeo_mslug_2001.files.append(JoinGameFile(["201-ca", "201-cb", "201-cc", "201-cd"], "201-c"))
    acaneogeo_mslug_2001.files.append(SplitGameFileEvenOdd("{rom}/" +acaneogeo_mslug_2001.rom_name +"/201-c", [("mslug_c1.rom", "mslug_c2.rom"),("mslug_c3.rom", "mslug_c4.rom")], int(0x400000))) # Broken
    acaneogeo_mslug_2001.files.append(DeleteGameFile(["201-c"]))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/sfix.sfix", "ng-sfix.rom"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-m1.m1", "ng-sm1.rom"))
    acaneogeo_mslug_2001.files.append(RenameGameFileOffset("mslug/201-p1.p1", "201-p1.p1a", int(0x100000)))
    acaneogeo_mslug_2001.files.append(SplitGameFile("mslug/201-p1.p1", ["201-p1.p1b"], int(0x100000)))
    acaneogeo_mslug_2001.files.append(JoinGameFile(["201-p1.p1a", "201-p1.p1b"], "201-p1.p1"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-s1.s1", "201-s1.s1"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-v1.v1", "201-v1.v1"))
    acaneogeo_mslug_2001.files.append(RenameGameFile("mslug/201-v2.v2", "201-v2.v2"))
    all_games.append(acaneogeo_mslug_2001)
    
    acaneogeo_mslug_2003 = Game("Metal Slug (MAME 2003)", conversion_type_acaneogeo, "ACA NEOGEO METAL SLUG v131072 (0100EBE002B3E800) (UPD)", "mslug-2003")
    acaneogeo_mslug_2003.compatibility.extend(["BROKEN - MAME-2003"])
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-c1.c1", "201-ca"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-c1.c2", "201-cb"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-c1.c3", "201-cc"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-c1.c4", "201-cd"))
    acaneogeo_mslug_2003.files.append(JoinGameFile(["201-ca", "201-cb", "201-cc", "201-cd"], "201-c"))
    acaneogeo_mslug_2003.files.append(SplitGameFileEvenOdd("{rom}/" +acaneogeo_mslug_2003.rom_name +"/201-c", [("201-c1.bin", "201-c2.bin"),("201-c3.bin", "201-c4.bin")], int(0x400000))) # Broken
    acaneogeo_mslug_2003.files.append(DeleteGameFile(["201-c"]))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-m1.m1", "201-m1.m1"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/sfix.sfix", "sfix.sfx"))
    acaneogeo_mslug_2003.files.append(RenameGameFileOffset("mslug/201-p1.p1", "201-p1.p1a", int(0x100000)))
    acaneogeo_mslug_2003.files.append(SplitGameFile("mslug/201-p1.p1", ["201-p1.p1b"], int(0x100000)))
    acaneogeo_mslug_2003.files.append(JoinGameFile(["201-p1.p1a", "201-p1.p1b"], "201-p1.p1"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-s1.s1", "201-s1.s1"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-v1.v1", "201-v1.v1"))
    acaneogeo_mslug_2003.files.append(RenameGameFile("mslug/201-v2.v2", "201-v2.v2"))
    all_games.append(acaneogeo_mslug_2003)
    
    acaneogeo_mslug = Game("Metal Slug", conversion_type_acaneogeo, "ACA NEOGEO METAL SLUG v131072 (0100EBE002B3E800) (UPD)", "mslug")
    acaneogeo_mslug.compatibility.extend(["FB Neo", "MAME-2004", "MAME-2005", "MAME-2006", "MAME-2007", "MAME-2008", "MAME-2009", "MAME-2010", "MAME-2015", "MAME-2016", "MAME-2017", "MAME-2018", "MAME-2019"])
    ...
    acaneogeo_mslug.files.append(RenameGameFile("mslug/sfix.sfix", "sfix.sfx"))
    ...
    acaneogeo_sonicwi2_2001 = Game("Aero Fighters 2 (MAME 2001)", conversion_type_acaneogeo, "ACA NEOGEO AERO FIGHTERS 2 v65536 (0100AC40038F4800) (UPD)", "sonicwi2-2001")
    acaneogeo_sonicwi2_2001.compatibility.extend(["MAME-2001"])
    acaneogeo_sonicwi2_2001.files.append(RenameGameFile("m1.bin.gz", "ng-sm1.rom"))
    acaneogeo_sonicwi2_2001.files.append(RenameGameFile("s1.bin.gz", "afig2_s1.rom"))
    acaneogeo_sonicwi2_2001.files.append(RenameGameFile("sfix.bin.gz", "ng-sfix.rom"))
    acaneogeo_sonicwi2_2001.files.append(SplitGameFile("v1.bin.gz", ["075-v1.v1"], int(0x200000)))
    acaneogeo_sonicwi2_2001.files.append(RenameGameFileOffset("v1.bin.gz", "075-v2.v2", int(0x200000))) #V2 is the incorrect size but seems to work.
    acaneogeo_sonicwi2_2001.files.append(RenameGameFileOffset("p1.bin.gz", "075-p1.p1a", int(0x100000)))
    acaneogeo_sonicwi2_2001.files.append(SplitGameFile("p1.bin.gz", ["075-p1.p1b"], int(0x100000)))
    acaneogeo_sonicwi2_2001.files.append(JoinGameFile(["075-p1.p1a", "075-p1.p1b"], "075-p1.p1"))
    acaneogeo_sonicwi2_2001.files.append(SplitGameFileEvenOdd("c1.bin.gz", [("075-c1.c1", "075-c2.c2")], int(0x200000)))
    acaneogeo_sonicwi2_2001.files.append(SplitGameFileEvenOddOffset("c1.bin.gz", [("075-c3.c3", "075-c4.c4")], int(0x200000), int(0x400000)))
    ...
    acaneogeo_zedblade_2001 = Game("Zed Blade (MAME 2001)", conversion_type_acaneogeo, "ACA NEOGEO ZED BLADE v0 (01005AF004DBC000) (BASE)", "zedblade-2001")
    acaneogeo_zedblade_2001.compatibility.extend(["MAME-2001"])
    acaneogeo_zedblade_2001.files.append(RenameGameFile("m1.bin.gz", "076-m1.m1"))
    acaneogeo_zedblade_2001.files.append(RenameGameFile("s1.bin.gz", "ng-sm1.rom"))
    acaneogeo_zedblade_2001.files.append(RenameGameFile("sfix.bin.gz", "ng-sfix.rom"))
    acaneogeo_zedblade_2001.files.append(SplitGameFile("v1.bin.gz", ["076-v1.v1", "076-v2.v2", "076-v3.v3"], 2097152))
    acaneogeo_zedblade_2001.files.append(SplitGameFile("p1.bin.gz", ["076-p1.p1"], int(0x080000)))
    acaneogeo_zedblade_2001.files.append(SplitGameFileEvenOdd("c1.bin.gz", [("076-c1.c1", "076-c2.c2")], int(0x200000)))
    acaneogeo_zedblade_2001.files.append(SplitGameFileEvenOddOffset("c1.bin.gz", [("076-c3.c3", "076-c4.c4")], int(0x200000), int(0x400000)))
    ...
    acaneogeo_pbobblen.files.append(RenameGameFile("m1.bin.gz", "d96-06.m1"))
    acaneogeo_pbobblen.files.append(RenameGameFile("s1.bin.gz", "d96-04.s1"))
    acaneogeo_pbobblen.files.append(RenameGameFile("sfix.bin.gz", "sfix.sfx"))
    acaneogeo_pbobblen.files.append(SplitGameFile("v1.bin.gz", ["068-v1.v1", "068-v2.v2", "d96-01.v3"], int(0x100000))) #068-v1.v1 and 068-v2.v2 are incorrect but unused.
    acaneogeo_pbobblen.files.append(SplitGameFileOffset("v1.bin.gz", ["d96-05.v4"], int(0x080000), int(0x300000)))
    acaneogeo_pbobblen.files.append(SplitGameFile("p1.bin.gz", ["d96-07.ep1"], int(0x080000)))
    acaneogeo_pbobblen.files.append(SplitGameFileEvenOdd("c1.bin.gz", [("068-c1.c1", "068-c2.c2"), ("068-c3.c3", "068-c4.c4")], int(0x100000)))  #Incorrect but unused.
    acaneogeo_pbobblen.files.append(SplitGameFileEvenOddOffset("c1.bin.gz", [("d96-02.c5", "d96-03.c6")], int(0x080000), int(0x400000)))
    all_games.append(acaneogeo_pbobblen)
    
    samsho_samsho = Game("Samurai Shodown", conversion_type_samuraishowdowncollection, "Main", "samsho")
    samsho_samsho.compatibility.extend(["FB Neo", "MAME-2008", "MAME-2009", "MAME-2010", "MAME-2011", "MAME-2012", "MAME-2013", "MAME-2014", "MAME-2015", "MAME-2016", "MAME-2017", "MAME-2018", "MAME-2019"])
    ...
    segaages_columns2 = Game("Columns 2", conversion_type_segaages, "Columns2_jp", "columns2")
    segaages_columns2.compatibility.extend(["MAME-2001", "MAME-2003"])
    segaages_columns2_cpu = SplitGameFileEvenOdd("cpu.bin", [("epr13361.rom", "epr13360.rom")], 128 * 1024)
    segaages_columns2.files.append(segaages_columns2_cpu)
    all_games.append(segaages_columns2)
    ...
    segaages_ichir_cpu = SplitGameFileEvenOdd("cpu.bin", [("pa2_32.bin", "pa2_31.bin")], int(0x080000))
    segaages_ichir.files.append(segaages_ichir_cpu)
    segaages_ichir_cpu_2 = SplitGameFileEvenOddOffset("cpu.bin", [("epr-16888.ic34", "epr-16887.ic33")], int(0x080000), int(0x100000))
    segaages_ichir.files.append(segaages_ichir_cpu_2)
    segaages_ichir_pcm = RenameGameFile("pcm.bin", "pa2_02.bin")
    segaages_ichir.files.append(segaages_ichir_pcm)
    all_games.append(segaages_ichir)
    
    segaages_ichidnte = Game("Ichidant-R (MAME 2003)", conversion_type_segaages, "IchidantR_us", "ichidnte")
    segaages_ichidnte.compatibility.extend(["MAME-2001", "MAME-2003", "MAME-2004"])
    segaages_ichidnte.files.append(segaages_ichir_cpu)
    segaages_ichidnte.files.append(segaages_ichir_cpu_2)
    segaages_ichidnte.files.append(segaages_ichir_pcm)
    all_games.append(segaages_ichidnte)
    ...
    segaages_ichirj_cpu = SplitGameFileEvenOdd("cpu.bin", [("epr-16886.ic32", "epr-16885.ic31")], int(0x080000))
    segaages_ichirj.files.append(segaages_ichirj_cpu)
    segaages_ichirj_cpu_2 = SplitGameFileEvenOddOffset("cpu.bin", [("epr-16888.ic34", "epr-16887.ic33")], int(0x080000), int(0x100000))
    segaages_ichirj.files.append(segaages_ichirj_cpu_2)
    segaages_ichirj_pcm = RenameGameFile("pcm.bin", "epr-16884.ic4")
    segaages_ichirj.files.append(segaages_ichirj_pcm)
    all_games.append(segaages_ichirj)
    
    segaages_ichidant = Game("Ichidant-R (Japan) (MAME 2003)", conversion_type_segaages, "IchidantR_jp", "ichidant")
    segaages_ichidant.compatibility.extend(["MAME-2001", "MAME-2003", "MAME-2004"])
    segaages_ichidant_cpu = SplitGameFileEvenOdd("cpu.bin", [("epr16886", "epr16885")], int(0x080000))
    segaages_ichidant.files.append(segaages_ichidant_cpu)
    segaages_ichidant.files.append(segaages_ichirj_cpu_2)
    segaages_ichidant_pcm = RenameGameFile("pcm.bin", "epr16884")
    segaages_ichidant.files.append(segaages_ichidant_pcm)
    all_games.append(segaages_ichidant)
